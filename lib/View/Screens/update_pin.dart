...
import 'package:fakka/View/Screens/update_pin2_.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:pinput/pinput.dart';

// ignore: must_be_immutable
class UpdatePinScreen1 extends StatelessWidget {
  UpdatePinScreen1({Key? key}) : super(key: key);
                  ...
                  onCompleted: (value) {
                    if (myCubit.userModel!.cardPassword ==
                      ...
                      Navigator.pushReplacement(
                          context,
                          MaterialPageRoute(
                            builder: (context) => UpdatePinScreen2(),
                          ));
                    } else {
